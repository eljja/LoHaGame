...
export const ENTITIES: Record<EntityType, EntityTypeDef> = {
  ...
  rabbit:       { icon: "🐇", label: "토끼",       terrain: ["grass", "forest"],  cap: 23,  respawn: true,  blocksMovement: false, reach: 1 },
  wolf:         { icon: "🐺", label: "야생 늑대",  terrain: ["forest"],           cap: 15,  respawn: true,  blocksMovement: false, reach: 1 },
  boar:         { icon: "🐗", label: "성난 멧돼지",terrain: ["grass", "forest"],  cap: 12,  respawn: true,  blocksMovement: false, reach: 1 },
  bear:         { icon: "🐻", label: "사나운 곰",  terrain: ["forest"],           cap: 8,   respawn: true,  blocksMovement: false, reach: 1 },
